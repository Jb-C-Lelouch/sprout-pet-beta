...
- **装饰陪伴行为。** 小芽会在小窝门口小睡、醒来伸懒腰，在石灯旁停留或观察花盆。照料优先，互动不耗精力。
- **成长纪念。** 长期保留首次开花、收获、投喂与访客发现的图文记录；旧成就不补写未知日期。
- **直接布置花园。** 选择植物与同区落点即可移动或交换，保留成长。小窝、石灯和花盆可免费摆放到空草地上，作为外观装饰。
- **陪伴互动。** 摸摸小芽，观看张望、伸懒腰和小睡；消耗一份收获投喂零食。右键可切换可拖动的迷你桌宠，继续时间成长，暂停自动照料。
...
当前是早期 Windows 测试版，尚未内置 Python。Token 读取依赖宿主的本地 transcript 格式，兼容性可能随 Codex 版本变化；无法读取用量时仍可按时间成长。自动劳动仅在桌面花园运行时进行，离线不模拟劳动。收获作物可以投喂小芽，没有交易或货币系统。干净电脑安装与真实宿主钩子连接仍需更多测试。
